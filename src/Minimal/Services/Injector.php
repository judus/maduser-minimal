...
use Maduser\Minimal\Services\Exceptions\ClassDoesNotExistException;
use Maduser\Minimal\Services\Exceptions\IocNotResolvableException;
use Maduser\Minimal\Services\Exceptions\UnresolvedDependenciesException;

/**
 * Class Injector
 *
 * @package Maduser\Minimal\Services
 */
class Injector
{
    /**
