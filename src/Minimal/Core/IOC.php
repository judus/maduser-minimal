...
use Maduser\Minimal\Exceptions\IocNotResolvableException;
use Maduser\Minimal\Exceptions\UnresolvedDependenciesException;

/**
 * Class IOC
 *
 * @package Maduser\Maduser\Minimal\Core
 */
class IOC
{
    /**
